...
class ShopRafart extends Component {
    constructor(props){
        super(props);
    }
    ...
    render(){
        ...
        return (
            <div className="container">
                ...
                //     <form>
                //         <input className="callToAction text mediumText" type="submit" value="Get this product"/>
                //     </form>
                // </Elements>

                <div>
                    <h2 className="text bigText">My Form here</h2>
                    <h2 className="text bigText centeredTitle">Pst and News</h2>
